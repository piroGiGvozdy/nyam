...
export declare type AdaptivityType = 'force_mobile' | 'force_mobile_compact' | 'adaptive';
...
export declare enum BannerAdAlign {
    LEFT = "left",
    RIGHT = "right",
    CENTER = "center"
}
export declare enum BannerAdHeightType {
    COMPACT = "compact",
    REGULAR = "regular"
}
export declare enum BannerAdOrientation {
...
export declare type PostAttachmentLink = {
    type: string;
    link: string;
};
...
export declare type ShowSlidesSheetResponse = {
    result: true;
} & ({
...
export declare type ShowSlidesSheetRequest = {
    slides: ActionSheetSlide[];
};
declare type TranslationLanguage = 'ru' | 'en' | 'es' | 'pt' | string;
...
export declare type CallStartResponse = {
    result: true;
    join_link: string;
};
export declare type CallJoinRequest = {
    join_link: string;
};
export declare type CallJoinResponse = {
    result: true;
};
export declare type CallGetStatusResponse = {
    result: true;
    is_active: boolean;
};
export declare type CallLeftResponse = {
    reason: string;
};
export declare type CallFinishedResponse = {
    result: true;
};
...
export declare type VKWebAppBannerAdUpdatedResponse = VKWebAppShowBannerAdResponse;
export declare type VKWebAppBannerAdClosedByUserResponse = Omit<VKWebAppShowBannerAdResponse, 'result'>;
...
export declare type AddToProfileRequest = {
    ttl?: number;
};
export declare type AddToProfileResponse = {
...
export declare type ReceiveDataMap = {
    ...
    SetSupportedHandlers: {
        supportedHandlers: Array<keyof RequestPropsMap>;
    };
    VKWebAppTrackEvent: {
        result: true;
    };
